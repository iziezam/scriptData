...
function CONNECTIONDB() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            port = Number(process_1.default.env.RUN_PORT);
            ip = String(process_1.default.env.IP);
            app.use(express_1.default.json());
            app.use((0, cors_1.default)());
            console.log("Preparing database connections");
            (0, common_1.dbConnection)()
                .then(function () {
                console.log("Preparing database connections completed");
            })
                .catch(function (err) {
                console.log("Database connections error: ".concat(err));
            });
            app.listen(port, ip, function () {
                console.log("Server SQL SCRIPT is running at http://".concat(ip, ":").concat(port));
            });
            console.log("SQL SCRIPT started");
            return [2];
        });
    });
}
